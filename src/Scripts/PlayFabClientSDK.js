function test() {  
    console.log("This is a log from the SDK");
    return null;
}
...
if (!PlayFab._internalSettings) {
    PlayFab._internalSettings = {
        ...
        GetServerUrl: function () {
            if (
                !(
                    PlayFab.settings.productionServerUrl.substring(0, 4) ===
                    "http"
                )
            ) {
                if (PlayFab._internalSettings.verticalName) {
                    return (
                        "https://" +
                        PlayFab._internalSettings.verticalName +
            ...
            var resultPromise = new Promise(function (resolve, reject) {
                ...
                xhr.onreadystatechange = function () {
                    if (this.readyState === 4) {
                        var xhrResult =
                            PlayFab._internalSettings.GetPlayFabResponse(
                                request,
                                this,
                                startTime,
                                customData
        ...
        UpdateAuthenticationContext: function (authenticationContext, result) {
            ...
            if (result.data.SessionTicket !== null) {
                ...
                authenticationContextUpdates.SessionTicket =
                    result.data.SessionTicket;
            }
        ...
        GetAuthInfo: function (request, authKey) {
            ...
            var authError =
                PlayFab._internalSettings.AuthInfoMap[authKey].authError;
            var authAttr =
                PlayFab._internalSettings.AuthInfoMap[authKey].authAttr;
    ...
    LoginWithAndroidDeviceID: function (
        ...
        var overloadCallback = function (result, error) {
            if (result != null) {
                ...
                authenticationContext =
                    PlayFab._internalSettings.UpdateAuthenticationContext(
                        authenticationContext,
                        result
                    );
            }
